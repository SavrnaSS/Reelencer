      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-7xl px-3 pb-5 pt-3 sm:px-6 sm:pb-6 sm:pt-5 lg:px-8">
          ...
          <div className="mx-auto mt-12 w-full max-w-[680px] sm:mt-14 lg:mt-20">
            <h1 className="text-[2.25rem] font-black tracking-[-0.03em] text-white sm:text-[2.8rem] lg:text-[3.35rem]">Register</h1>
              ...
              <div className="space-y-5">
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                  <button
                    onClick={() => void signUp()}
                    disabled={loading}
                    className="flex h-12 w-full items-center justify-center rounded-[1rem] bg-[#8fe05f] px-6 text-sm font-extrabold tracking-[-0.02em] text-[#0b1914] transition hover:bg-[#9ae86a] disabled:cursor-not-allowed disabled:opacity-60 sm:h-14 sm:w-fit sm:rounded-[1.2rem] sm:px-8 sm:text-base"
                  >
